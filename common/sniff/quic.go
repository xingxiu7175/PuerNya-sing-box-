...
func QUICClientHello(ctx context.Context, packet []byte, sniffdata chan SniffData, wg *sync.WaitGroup) {
...
find:
	...
	var tlsdata SniffData
	tlsClientHello(ctx, io.MultiReader(readers...), &tlsdata)
